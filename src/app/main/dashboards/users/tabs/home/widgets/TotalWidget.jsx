...
function TotalWidget() {
	const { data: widgets, isLoading } = useGetUserDashboardWidgetsQuery();
	const widget = widgets.total;
	...
	return (
		<Paper className="flex flex-col flex-auto shadow rounded-2xl overflow-hidden">
			...
			<div className="text-center mt-8">
				<Typography className="text-7xl sm:text-8xl font-bold tracking-tight leading-none text-blue-600 dark:text-blue-500">
					{String(data.count)}
				</Typography>
