...
import { useGetUserDashboardFormersQuery } from '../../../UserDashboardApi';
//import OrdersStatus from '../order/OrdersStatus';

function FormersTable() {
	const { data: formers, isLoading } = useGetUserDashboardFormersQuery();
	...
	const columns = useMemo(
		() => [
			...
			},
			{
				...
				accessorKey: 'domainesExpertise',
				header: 'Domaines Expertise'
			}
		],
		[]
	);
